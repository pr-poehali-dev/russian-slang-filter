...
const JargonExamples: React.FC = () => {
  return (
    <section className="my-12 bg-white p-6 rounded-lg shadow-md">
      ...
      <p className="mb-6">
        Ниже представлены распространенные жаргонизмы, которые всё чаще
        встречаются в повседневной речи. Обратите внимание на их литературные
        аналоги, которые точнее и выразительнее передают смысл.
      </p>
